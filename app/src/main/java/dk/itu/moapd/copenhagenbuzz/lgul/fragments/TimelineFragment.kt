...
class TimelineFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        lifecycleScope.launch {
            dataViewModel.fakeEventFetch()
        }
        dataViewModel.generateRandomFavorites(dataViewModel.events.value)


        val tmp = dataViewModel.events.value.toString()
        Log.d("data", tmp)

        val adapter = EventAdapter(dataViewModel.events.value, dataViewModel.favorites.value)
